...
public class TopHomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.top_home_fragment, container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        TopHomeFragment.ViewPagerAdapter adapter = new TopHomeFragment.ViewPagerAdapter(getChildFragmentManager());
        adapter.addFragment(new TopMoviesFragment(),"Top Rated Movies");
        adapter.addFragment(new TopTvshowFragment(),"Top Rated TV Shows");
