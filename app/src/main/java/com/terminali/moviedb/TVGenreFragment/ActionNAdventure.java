...
public class ActionNAdventure extends Fragment {
    ...
    private void fetchBoxofficeMovies() {
        ...
        for (int i = 10; i >= 1; i--) {
            ...
            client.getDiscover("discover/tv",10759,"popularity.desc",i, new JsonHttpResponseHandler() {
