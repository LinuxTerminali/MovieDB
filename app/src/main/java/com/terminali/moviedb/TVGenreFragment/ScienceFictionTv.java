...
public class ScienceFictionTv extends Fragment {
    ...
    private void fetchBoxofficeMovies() {
        ...
        for (int i = 10; i >= 1; i--) {
            ...
            client.getDiscover("discover/tv",10765,"popularity.desc",i, new JsonHttpResponseHandler() {
